...
const translations: Record<AppLocale, Translations> = {
  en: {
    ...
    footerStatement: "Independent design and development from 67° N 14° E.",
    ...
    headerHeroDescription:
      "I shape the idea and build the experience—for businesses and creative teams.",
    headerProjectsCta: "View projects",
    headerLocation: "LOCATION 67° N 14° E",
    ...
    contactAvailableCopy:
      "Selected projects / studio collaborations / permanent roles",
  ...
  nb: {
    ...
    footerStatement: "Selvstendig design og utvikling fra 67° N 14° E.",
    ...
    headerLocation: "LOKASJON 67° N 14° E",
    ...
    contactAvailability:
      "Tilgjengelig for nye oppdrag — lokalt og internasjonalt.",
    contactEmailNote:
    ...
    contactAvailableCopy:
      "Utvalgte prosjekter / studiosamarbeid / faste roller",
