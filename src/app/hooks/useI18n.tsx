...
const translations: Record<AppLocale, Translations> = {
	en: {
		...
		expertiseModes: [
			...
			{ title: "UX/UI & Interactions", description: "Make structure, feedback, and movement clear enough to guide people naturally.", meta: "02 / interaction" },
			{ title: "Digital products", description: "Turn the direction into responsive interfaces and systems built for real content.", meta: "03 / product" },
			{ title: "Creative frontend", description: "Carry the decisions into components, motion, and production-ready front-end.", meta: "04 / development" },
		],
	...
	nb: {
		...
		expertiseModes: [
			...
			{ title: "UX/UI & Interactions", description: "Struktur, respons og bevegelse gjør grensesnittet enkelt å forstå og bruke.", meta: "02 / interaksjon" },
			{ title: "Digitale produkter", description: "Retningen blir til responsive nettsider og systemer bygget for reelt innhold.", meta: "03 / produkt" },
			{ title: "Kreativ frontend", description: "Jeg tar designet inn i komponenter, animasjon og produksjonsklar frontend.", meta: "04 / utvikling" },
		],
