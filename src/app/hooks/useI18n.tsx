...
const translations: Record<AppLocale, Translations> = {
	en: {
		...
		expertiseTitleLineOne: "From direction to",
		expertiseTitleLineTwo: "finished front-end.",
		...
		expertiseModes: [
			...
			{ title: "UX/UI", description: "Make structure, feedback, and movement clear enough to guide people naturally.", meta: "02 / interaction" },
			...
			{ title: "Front-end", description: "Carry the decisions into components, motion, and production-ready front-end.", meta: "04 / development" },
		],
	...
	nb: {
		...
		expertiseTitleLineOne: "Fra retning til",
		expertiseTitleLineTwo: "ferdig frontend.",
		...
		expertiseModes: [
			...
			{ title: "UX/UI", description: "Struktur, respons og bevegelse gjør grensesnittet enkelt å forstå og bruke.", meta: "02 / interaksjon" },
			{ title: "Digitale produkter", description: "Retningen blir til responsive grensesnitt og systemer bygget for ekte innhold.", meta: "03 / produkt" },
			{ title: "Frontend", description: "Jeg tar valgene inn i komponenter, motion og produksjonsklar frontend.", meta: "04 / utvikling" },
		],
