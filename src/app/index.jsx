			...
			<main>
				...
				<section className={styles.work__section}>
					<Reveal>
						...
						<ProjectImage
							href="/manshausen"
							projectTitle="Manshausen Island"
							projectImageSrc="/projects/manshausen.jpg"
							alt="Preview image for a personal project redesigning and developing Manshausen Island's website"
							projectTags={["UI", "Web Dev"]}
						/>
						...
						<Reveal>
							...
							<div className={styles.experience__list}>
								<div className={styles.experience__info}>
									...
									<h4>
										<a href="https://www.dx.tech/" target="_blank" rel="noreferrer">
											DX
										</a>
									</h4>
									<span>2019 - 2020</span>
							...
							<div className={styles.experience__list}>
								<div className={styles.experience__info}>
									...
									<h4>
										<a href="https://www.unfold.no" target="_blank" rel="noreferrer">
											Unfold
										</a>
									</h4>
									<span>2018</span>
							...
							<div className={styles.experience__list}>
								<div className={styles.experience__info}>
									<span>Oslo, Norway</span>
									<h4>
										<a href="https://www.trigger.no/" target="_blank" rel="noreferrer">
											Trigger
										</a>
									</h4>
									<span>2016</span>
