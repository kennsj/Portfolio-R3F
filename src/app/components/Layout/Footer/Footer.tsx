		...
		<footer id="contact" className={styles.footer}>
			<div className={styles.inner}>
				...
				<div className={styles.details}>
					...
					<div className={styles.meta}>
						...
						<div>
							...
							<a href="https://www.linkedin.com/in/kennethstrandjorgensen/" target="_blank" rel="noreferrer">LinkedIn</a>
							<a href="https://github.com/kennsj" target="_blank" rel="noreferrer">GitHub</a>
						</div>
					</div>
				</div>
				...
				<div className={styles.utility}>
					...
					<div className={styles.languages} role="group" aria-label={t.languageSwitchLabel}>
					...
					<a className={styles.top} href="#top">{t.footerBackToTop} <ArrowIcon direction="up" /></a>
				</div>
			</div>
		</footer>
	)
