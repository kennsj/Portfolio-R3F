...
export const Route = createFileRoute("/sno")({
	component: SnoPage,
})
		...
		<main>
			...
			<section className={styles.work__section}>
				...
				<h2>
					...
					an interactive experiences which transcends visitors from a potentional
					30 degree celsius weather to a below freezing atmosphere inside?
				</h2>
				...
				<p>
					...
					intertwined to a theme, a season, an event, etc. through the visual and
					interactive. In addition, it could be used to manage user flow and
